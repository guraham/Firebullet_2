...
// TODO: 砲台の位置を画面左に、ターゲットの位置を画面右に移動させる。(A)　HW16A194 峯岡侑史
// TODO: 雲の位置を左から右に動かす。見えなくなったら左端に戻す。(B)HW16A178 前田祐希
// TODO: 砲台を青い壁に沿って上下に動かす。(C)HW16A178 前田祐希
// TODO: 弾のスピードを速くし、弾が画面右端を通り越したら再度発射可能にする。(D)HW16A190 水本浩暉
// TODO: スコアのサイズを大きくする。(E)　HW16A190 水本浩暉
// TODO: スコアを100点ずつ加算するようにし、5桁の表示に変える。(F) HW16A194 峯岡侑史
// TODO: PlayBGM()関数を使って、BGMを再生する。(G) HW16A194 峯岡侑史
...
>>>>>>> 07d7ec53d09baf23ce26e8c42afe876bc0776446
}
